...
class RandomNumber(commands.Cog):
    ...
    async def rand_number(self, ctx, number_string: str = None):
        rand_numb = None
            ...
            if len(rand_min_max) <= 1:
                ...
                try:
                    ...
                    if max_numb - min_numb > 0:
                        ...
                        respond = "{} Random number: **{:,}**".format(
                            ctx.author.mention, rand_numb
                        )
                except ValueError:
                    pass
    ...
    @commands.slash_command(
        ...
        options=[
            Option(
                "range_number",
                "Enter a range from to (ex. 1-100)",
                OptionType.string,
                required=False,
            )
        ],
    ...
    async def rand(self, ctx, range_number: str = None):
